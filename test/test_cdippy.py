...
import cdippy.location as l
import cdippy.ndbc as ndbc
import cdippy.spectra as sp

def get_active_datasets(dataset_name):
    url = 'http://thredds.cdip.ucsd.edu/thredds/catalog/cdip/'+dataset_name+'/catalog.xml'
...
class TestCdipnc(unittest.TestCase):
    ...
    def test_url(self):
        ...
        self.assertEqual(a.url, 'https://cdip.ucsd.edu/thredds/dodsC/cdip/archive/100p1/100p1_d01.nc')
...
class TestMopData(unittest.TestCase):
    ...
    def test_url(self):
        ...
        self.assertEqual(m.url, 'https://thredds.cdip.ucsd.edu/thredds/dodsC/cdip/model/MOP_validation/BP100_ecmwf_fc.nc')
...
class TestSpectra(unittest.TestCase):
    ...
    def test_mk3mk4_redistribute(self):
        ...
        data_mk4 = self.s271.get_spectra(self.dt_271_3, self.dt_271_4, force_64bands=True)
...
class TestStnData(unittest.TestCase):
    ...
    def test_across_deployments(self):
        d = self.s.get_series('2007-05-30 00:00:00',
                              '2007-06-01 23:59:59', ['xyzData'], 'public')
    ...
    def test_ww3(self):
        ...
        d = s.get_series('2016-08-01 23:00:00',
                         '2016-08-01 23:59:59', ['waveHs'])
...
class TestLatest(unittest.TestCase):
    ...
    def test_get_latest(self):
        d = self.latest.get_latest(pub_set='both-all',
                                   meta_vars=['metaLongitude',
                                              'metaLatitude',
                                              'metaWaterDepth',
                                              'metaDeployLabel',
                                              'metaWMOid',
        ...
        self.assertEqual('gpsLatitude' in d, True) and \
        self.assertEqual('groupTime' in d, True) and \
        self.assertEqual('sstTimeBounds' in d, True) and \
        self.assertEqual('metaWMOid' in d, True)
...
class TestNcStats(unittest.TestCase):
    ...
    def test_summary(self):
        ...
        self.assertEqual(summary['d12']['time_coverage_start'],
                         datetime(2013, 12, 13, 22, 0, 0))
...
class TestLocation(unittest.TestCase):
    ...
    def setUp(self):
        ...
        lat2 = 21.66915
        lon2 = -158.11487
        self.l1 = l.Location(lat1, lon1)
        self.l2 = l.Location(lat2, lon2)
...
suite.addTests([cdipnc_suite, mopdata_suite, stndata_suite, latest_suite, ncstat_suite, nchash_suite, ndbc_suite, spectra_suite])
