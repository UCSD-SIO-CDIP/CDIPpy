...
class CDIPnc:
    ...
    active_datasets = {'predeploy': 'p0', 'moored': 'p1',
                       'offsite': 'p2', 'recovered': 'p3'}
    ...
    def __make_masked_array(self, nc_var: str, s_idx: int, e_idx: int) -> np.ma.masked_array :
    ...
    def make_pub_mask(self, anc_name: str, s_idx: int, e_idx: int) -> np.ndarray :
        ...
        elif (anc_name == 'waveFlagPrimary' or anc_name == 'sstFlagPrimary' or
              anc_name == 'acmFlagPrimary' or anc_name == 'cat4FlagPrimary'):
    ...
    def set_dataset_info(self, stn: str, org: str, dataset_name: str, deployment: int = None) -> None :
...
class Latest(CDIPnc):
    ...
    def __init__(self, data_dir: str = None ):
        ...
        if self.data_dir:
            ...
            self.url = '/'.join([CDIPnc.THREDDS_url, CDIPnc.dods,
                                 'cdip/realtime/latest_3day.nc'])
    ...
    def get_latest(self, 
        pub_set: str = 'public', meta_vars: list = None, params: list = None, array_format=True) -> list :
        """ 
        ...
        default_params_by_type = {
            ...
            'meta': ['metaLongitude', 'metaLatitude', 'metaWaterDepth', 
                 'metaStationName', 'metaSiteLabel', 'metaDeployLabel', 'metaWMOid'],
        }
...
class Active(CDIPnc):
    ...
    def __init__(self, stn: str, deployment: int, active_state_key: str, data_dir: str = None, org: str = None):
        """ 
            PARAMETERS
            ----------
            stn : str
