...
class MopData(CDIPnc):
    ...
    spectrum_vars = [
        ...
        'waveA2Value', 'waveB2Value', 'waveCheckFactor', 'waveHs']
    meta_vars = [
    ...
    def __init__(self, mop_id: str, dataset_name: str, data_dir: str = None):
        ...
        prefix = mop_id[0:2]
        MOP_type = 'MOP_validation' if prefix in self.validation_prefixes else 'MOP_alongshore'
        ...
        if __using_path:
            ...
            self.url = '/'.join([self.THREDDS_url, 'thredds/dodsC/cdip/model', MOP_type, self.filename])
    ...
    def get_parameters(self, 
        ...
        return self.get_series(start, end, self.parameter_vars, apply_mask, target_records)

    def get_spectra(self, 
        start: datetime = None, 
        end: datetime = None, 
        apply_mask: bool = True, 
        target_records: int = 0) -> dict :
        """ Calls get_series to return spectral data. """
        return self.get_series(start, end, self.spectrum_vars, apply_mask, target_records)
    ...
    def get_target_timespan(self, target_timestamp: int, num_target_records: int, time_var: str) -> tuple:
        ...
        if i_b == last_idx or stamps[i_b] == target_timestamp:
            ...
            closest_idx = tsu.get_closest_index(
